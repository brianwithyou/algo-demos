...
//        int sum = new Solution().maxSumAfterPartitioning(new int[]{1, 15, 7, 9, 2, 5, 10}, 3);    // 84
//        int sum = new Solution().maxSumAfterPartitioning(new int[]{1,4,1,5,7,3,6,1,9,9,3}, 3);  // 78
//        int sum = new Solution().maxSumAfterPartitioning(new int[]{1,4,1,5,7,3,6,1,9,9,3}, 4);  // 83
        int sum = new Solution0_Recursion().maxSumAfterPartitioning(new int[]{581920,200100,526972,677934,989025,294832,581857,663919,961334,1881,859626,251114,361905,867006,86001,836946,894279,859796,750025,898166,674980,939280,458563,117387,403337,961067,589597,73584,178968,955900,755634,609754,97612,19699,843950,907919,883083,522938,670930,671679,390248,704834,188158,226340,80496,701795,867627,280988,465918,748627,321025,564279,79716,786173}, 23);  // 83
